...
class CallWindow(tk.Tk):
    def __init__(self, data):
        ...
        self.bg_label = tk.Label(self, width=100, height=100, bg='#ECf5FF')
        self.bg_label.place(anchor=tk.NW, x=0, y=0)
        ...
        self.show_label.place(anchor=tk.NW, x=21, y=40)
        ...
        self.btn_start.place(anchor=tk.NW, x=20, y=200)
        ...
        self.btn_end.place(anchor=tk.NW, x=232, y=200)
